 ...
 * @author frostyve
 */
public class DataTA extends javax.swing.JFrame {
    private DefaultTableModel model;

    /**
     * Creates new form DataTA
     */
    public DataTA() {
            initComponents();
             model = new DefaultTableModel ( );
             tblTA.setModel(model);
             model.addColumn("IDTA");
     ...
     try{
           ...
           while(res.next ()){
                ...
                obj[0] = res.getString("id_ta"); 
                obj[1] = res.getString("id_lulusan");
                obj[2] = res.getString("judul"); 
                obj[3] = res.getString("pembimbing");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataTA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
